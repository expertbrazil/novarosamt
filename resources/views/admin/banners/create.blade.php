    ...
    <div class="md:flex md:items-center md:justify-between">
        <div class="min-w-0 flex-1">
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500 dark:text-gray-400">Novo Banner</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Adicione um novo banner ao sistema
            </p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('admin.banners.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Imagem para exibição em telas desktop (recomendado: 1920x600px)
                        </p>
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Imagem para exibição em dispositivos móveis (recomendado: 768x400px)
                        </p>
